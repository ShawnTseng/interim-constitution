<!-- ChatGPT prompt
Please translate the following content into Traditional Chinese, using Taiwanese idioms and keeping it concise.

Make sure to translate the following words into the specified terms:
[constitution] -> [憲法],
[guardrails] -> [保障措施],
[workshops] -> [研討會],
[collaboration] -> [合作],
